                            ...
                            <div class="invoice-box row">
                                <div class="col-sm-12">
                                    <table class="table mt-0 table-responsive invoice-table table-borderless">
                                        <tbody>
                                            <tr>
                                                <td>{{ $booking->business_name }},<br>{{ $booking->business_address }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>{{ $booking->business_email }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>{{ $booking->business_website }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>{{ $booking->business_number }}
                                                </td>
                                            </tr>
                                            <tr>
                    ...
                    <div class="row invoive-info d-print-inline-flex">
                        <div class="col-sm-8">
                            ...
                            <table class="table mt-0 table-responsive invoice-table invoice-order table-borderless">
                                <tbody>
                                    <tr>
                                        <th>{{ __('Booking Seat Date') }} : </th>
                                        <td>{{ UtilityFacades::date_time_format($bookingValue->booking_seats_date) }}</td>
                                    </tr>
                                    <tr>
                                        <th>{{ __('Booking Seats') }} :</th>
                                        <td>{{ $bookingValue->booking_seats }}</td>
                                    </tr>
                                    <tr>
                                        <th>{{ 'Status' }} :</th>
                                        <td>
