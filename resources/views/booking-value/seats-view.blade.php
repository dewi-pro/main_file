...
@section('breadcrumb')
    <div class="col-md-12">
        ...
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item">{!! Html::link(route('view.booking.values', $bookingValue->booking_id),__('Submitted Bookings of ' . ' ' . $booking->business_name),[''],) !!}</li>
                                        ...
                                        @elseif($row->type == 'video')
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <form
                                                        action="{{ route('selfie.image.download', $bookingValue->id) }}"
                                                        method="GET">
                                ...
                                <p class="mb-0 d-flex align-items-center justify-content-between text-muted">
                                    {{ __('Transaction Id:') }} <strong class="ms-sm-2 text-body">
                                        @if (isset($bookingValue) && $bookingValue->transaction_id)
                                            <strong
                                                class="ms-sm-2 text-body">{{ $bookingValue->transaction_id }}</strong>
                                        @else
                            ...
                            <div class="d-flex flex-column">
                                <p class="mb-0 d-flex align-items-center justify-content-between text-muted">
                                    <strong>{{ __('Session') }}:</strong><strong
                                        class="ms-sm-2 text-body">{{ $bookingValue->booking_seats_session }}</strong>
                                </p>

                            </div>
                            <ul class="mt-3 event-cards list-group list-group-flush w-100">
                                @php
                                    $bookingSlots = explode(',', $bookingValue['booking_seats']);
                                @endphp
