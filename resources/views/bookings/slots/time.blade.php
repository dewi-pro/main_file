                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    {!! Form::radio(
                                        'slot_duration',
                                        '15',
                                        $timeWiseBooking ? ($timeWiseBooking->slot_duration_minutes == '15' ? true : false) : true,
                                        [
                                            'class' => 'btn-check',
                                            'id' => 'slot_duration_1',
                                            $timeWiseBooking && $timeWiseBooking->slot_duration_minutes == '15' ? 'checked' : false,
                                        ],
                                    ) !!}
                                    {!! Form::label('slot_duration_1', __('15 Min'), ['class' => 'btn btn-outline-primary']) !!}
                                    {!! Form::radio(
                                        'slot_duration',
                                        '30',
                                        $timeWiseBooking && $timeWiseBooking->slot_duration_minutes == '30' ? true : false,
                                        [
                                            'class' => 'btn-check',
                                            'id' => 'slot_duration_2',
                                            $timeWiseBooking && $timeWiseBooking->slot_duration_minutes == '30' ? 'checked' : false,
                                        ],
                                    ) !!}
                                    {!! Form::label('slot_duration_2', __('30 Min'), ['class' => 'btn btn-outline-primary']) !!}
                                    {!! Form::radio(
                                        'slot_duration',
                                        '45',
                                        $timeWiseBooking && $timeWiseBooking->slot_duration_minutes == '45' ? true : false,
                                        [
                                            'class' => 'btn-check',
                                            'id' => 'slot_duration_3',
                                            $timeWiseBooking && $timeWiseBooking->slot_duration_minutes == '45' ? 'checked' : false,
                                        ],
                                    ) !!}
                                    {!! Form::label('slot_duration_3', __('45 Min'), ['class' => 'btn btn-outline-primary']) !!}
                                    {!! Form::radio(
                                        'slot_duration',
                                        '60',
                                        $timeWiseBooking && $timeWiseBooking->slot_duration_minutes == '60' ? true : false,
                                        [
                                            'class' => 'btn-check',
                                            'id' => 'slot_duration_4',
                                            $timeWiseBooking && $timeWiseBooking->slot_duration_minutes == '60' ? 'checked' : false,
                                        ],
                                    ) !!}
                                    {!! Form::label('slot_duration_4', __('60 Min'), ['class' => 'btn btn-outline-primary']) !!}
                                    {!! Form::radio(
                                        'slot_duration',
                                        'custom_min',
                                        $timeWiseBooking && $timeWiseBooking->slot_duration == 'custom_min' ? true : false,
                                        [
                                            'class' => 'btn-check',
                                            'id' => 'slot_duration_5',
                                            $timeWiseBooking && $timeWiseBooking->slot_duration_minutes == 'custom_min' ? 'checked' : false,
                                        ],
                                    ) !!}
                                    {!! Form::label('slot_duration_5', __('Custom Min'), ['class' => 'btn btn-outline-primary']) !!}
                                </div>
                                <div id="custom_min"
                                    class="row {{ $timeWiseBooking && $timeWiseBooking->slot_duration == 'custom_min' ? '' : 'd-none' }}">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            {{ Form::label('slot_duration_minutes', __('Slot Duration Minutes'), ['class' => 'form-label']) }}
                                            {!! Form::number(
                                                'slot_duration_minutes',
                                                $timeWiseBooking && $timeWiseBooking->slot_duration_minutes ? $timeWiseBooking->slot_duration_minutes : null,
                                                [
                                                    'class' => 'form-control',
                                                    'placeholder' => __('Enter slot duration minutes'),
                                                ],
                                            ) !!}
                                        </div>
                                    </div>
                        ...
                        <div id="step2" class="row step d-none">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-8">
                                            {{ Form::label('intervals_time', __('Session Time'), ['class' => 'form-label']) }}
                                        </div>
                                ...
                                <div class="form-group intervals-time {{ $timeWiseBooking && $timeWiseBooking->intervals_time_status == '1' ? '' : 'd-none' }}">
                                    <div class="repeater1">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            {!! Form::radio(
                                                'date_format',
                                                'm/d/Y',
                                                $timeWiseBooking ? ($timeWiseBooking->date_format == 'm/d/Y' ? true : false) : true,
                                                [
                                                    'class' => 'btn-check',
                                                    'id' => 'date_format_1',
                                                ],
                                            ) !!}
                                            {!! Form::label('date_format_1', __('MM/DD/YYYY'), ['class' => 'btn btn-outline-primary']) !!}
                                            {!! Form::radio(
                                                'date_format',
                                                'd/m/Y',
                                                $timeWiseBooking && $timeWiseBooking->date_format == 'd/m/Y' ? true : false,
                                                [
                                                    'class' => 'btn-check',
                                                    'id' => 'date_format_2',
                                                ],
                                            ) !!}
                                            {!! Form::label('date_format_2', __('DD/MM/YYYY'), ['class' => 'btn btn-outline-primary']) !!}
                                            {!! Form::radio(
                                                'date_format',
                                                'Y/m/d',
                                                $timeWiseBooking && $timeWiseBooking->date_format == 'Y/m/d' ? true : false,
                                                [
                                                    'class' => 'btn-check',
                                                    'id' => 'date_format_3',
                                                ],
                                            ) !!}
                                            {!! Form::label('date_format_3', __('YYYY/MM/DD'), ['class' => 'btn btn-outline-primary']) !!}
                                        </div>
                                    </div>
                                    <div class="mb-2 col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            {!! Form::radio(
                                                'time_format',
                                                '24_hour',
                                                $timeWiseBooking ? ($timeWiseBooking->time_format == '24_hour' ? true : false) : true,
                                                [
                                                    'class' => 'btn-check',
                                                    'id' => 'time_format_1',
                                                ],
                                            ) !!}
                                            {!! Form::label('time_format_1', __('24 Hour'), ['class' => 'btn btn-outline-primary']) !!}
                                            {!! Form::radio(
                                                'time_format',
                                                'am/pm',
                                                $timeWiseBooking && $timeWiseBooking->time_format == 'am/pm' ? true : false,
                                                [
                                                    'class' => 'btn-check',
                                                    'id' => 'time_format_2',
                                                ],
                                            ) !!}
                                            {!! Form::label('time_format_2', __('AM/PM'), ['class' => 'btn btn-outline-primary']) !!}
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-8">
