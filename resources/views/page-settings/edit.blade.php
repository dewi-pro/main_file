                        ...
                        <div class="card">
                            <div class="tab-pane fade show active" id="apps-setting" role="tabpanel"
                                ...
                                {!! Form::model($pageSettings, [
                                    'route' => ['page-setting.update', $pageSettings->id],
                                    'method' => 'patch',
                                    'id' => 'froentend-form',
                                ]) !!}
                                @method('put')
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                *
                                                {!! Form::text('page_title', $pageSettings->title, [
                                                    'class' => 'form-control',
                                        ...
                                        <div class="col-md-12  {{ $pageSettings->type == 'link' ? 'block' : 'd-none' }}" id="link">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-muted"><b>{{ __('Internal Link') }}</b> :- {{ __('http://localhost/Prime-Laravel-Form-Builder/main_file/') }}</small><br>
                                        ...
                                        <div class="col-md-12 {{ $pageSettings->type == 'desc' ? 'block' : 'd-none' }}" id="description">
                                            <div class="form-group">
