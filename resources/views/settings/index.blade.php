            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4 form-check form-switch custom-switch-v1">
                                                <label class="mt-2 custom-switch float-end">
                                                    {!! Form::checkbox('landing_page', null, Utility::getsettings('landing_page') == '1' ? true : false, [
                                                        'data-onstyle' => 'primary',
                                                        'data-toggle' => 'switchbutton',
                                                        'class' => 'custom-control custom-switch form-check-input input-primary',
                                                    ]) !!}
                        ...
                        <div class="card" id="settings-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    {{ Form::label('localsetting', __('Local'), ['class' => 'btn btn-outline-primary']) }}

                                    {!! Form::radio('storage_type', 's3', Utility::getsettings('storage_type') == 's3' ? true : false, [
                                        'class' => 'btn-check',
                                        'id' => 's3setting',
                                    ]) !!}
                                    {{ Form::label('s3setting', __('S3 setting'), ['class' => 'btn btn-outline-primary']) }}

                                    {!! Form::radio('storage_type', 'wasabi', Utility::getsettings('storage_type') == 'wasabi' ? true : false, [
                                        'class' => 'btn-check',
                                        'id' => 'wasabisetting',
                                    ]) !!}
                                    {{ Form::label('wasabisetting', __('Wasabi'), ['class' => 'btn btn-outline-primary']) }}
                        ...
                        <div class="card" id="settings-card">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-4 text-end">
                                        <div class="form-switch custom-switch-v1 d-inline-block">
                                            ...
                                            <small
                                                class="text-end d-flex mt-2">{{ __('Please turn on this Email enable button.') }}</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-footer">
                                <div class="">
                                    ...
                                    {!! Form::button(__('Save'), ['type' => 'submit', 'class' => 'mt-2 btn btn-primary float-end']) !!}
                                </div>
                            </div>
                        </div>
                        {!! Form::close() !!}
                                ...
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-6 text-end">
                                        <div class="form-switch custom-switch-v1 d-inline-block">
                                            ...
                                            <small
                                                class="text-end d-flex mt-2">{{ __('Please turn on this Captcha Enable button.') }}</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div id="recaptcha"
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('recaptcha_key', Utility::getsettings('captcha_sitekey'), [
                                                    'class' => 'form-control',
                                            ...
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('recaptcha_secret', Utility::getsettings('captcha_secret'), [
                                                    'class' => 'form-control',
                        ...
                        <div class="justify-content-between card-header d-flex align-items-center">
                            ...
                            <div class="d-flex align-items-center text-end">
                                <div class="custom-control custom-switch" onclick="enableseo()">
                                    ...
                                    <small
                                        class="text-end d-flex mt-2">{{ __('Please turn on this SEO Enable button.') }}</small>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card" id="settings-card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            {{ Form::label('cache_size', __('Current cache size'), ['class' => 'form-label']) }}
                                            <div class="input-group">
                                                {!! Form::text('cache_size', Utility::GetCacheSize(), [
                                                    'class' => 'form-control',
                                                    'readonly',
                            ...
                            <div class="justify-content-between card-header d-flex align-items-center">
                                ...
                                <div class="d-flex align-items-center text-end">
                                    <div class="custom-control custom-switch" onclick="enablecookie()">
                                        ...
                                        <small
                                            class="text-end d-flex mt-2">{{ __('Please turn on this Cookie Enable button.') }}</small>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row cookieDiv">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('cookie_title', Utility::getsettings('cookie_title'), ['class' => 'form-control', 'placeholder' => __('Enter cookie title')]) }}
                                        </div>
                                        <div class="form-group">
                                            {{ Form::label('cookie_description', __('Cookie Description'), ['class' => 'form-label']) }}
                                            {!! Form::textarea('cookie_description', Utility::getsettings('cookie_description'), [
                                                'class' => 'form-control',
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::textarea('strictly_cookie_description', Utility::getsettings('strictly_cookie_description'), [
                                                'class' => 'form-control ',
                                                'placeholder' => __('Enter strictly cookie description'),
                                                'rows' => '3',
                                            ]) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            ...
                                            {{ Form::text('more_information_description', Utility::getsettings('more_information_description'), [
                                                'class' => 'form-control',
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('contactus_url', Utility::getsettings('contactus_url'), ['class' => 'form-control', 'placeholder' => __('Enter contact url')]) }}
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                            ...
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-6 text-end">
                                    <div class="form-switch custom-switch-v1 d-inline-block">
                                        ...
                                        <small
                                            class="text-end d-flex mt-2">{{ __('Please turn on this SMS enable button.') }}</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="google-calender-setting" class="card">
                        <div class="col-md-12">
                            {{ Form::open(['route' => 'settings.google-calender.update', 'method' => 'POST', 'data-validate', 'novalidate', 'enctype' => 'multipart/form-data']) }}
                            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                    ...
                                    <div class="col-6 text-end">
                                        <div class="">
                                            <div class="form-switch custom-switch-v1 d-inline-block">
                                                ...
                                                <small
                                                    class="text-end d-flex mt-2">{{ __('Please turn on this Google calendar enable button.') }}</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body google_calender">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                        {{ Form::label('google_calendar_id', __('Google Calendar Id'), ['class' => 'col-form-label']) }}
                                        {{ Form::text('google_calendar_id', UtilityFacades::getsettings('google_calendar_id'), ['class' => 'form-control ', 'placeholder' => 'Google Calendar Id', 'required' => true]) }}
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                        {{ Form::label('Google_calendar_json_file', __('Google Calendar json File'), ['class' => 'col-form-label']) }}
                                        {{ Form::file('google_calendar_json_file', ['class' => 'form-control', 'id' => 'file']) }}
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="google-map-setting" class="card">
                        <div class="col-md-12">
                            {{ Form::open(['route' => 'settings.googlemap.update', 'method' => 'POST', 'data-validate', 'novalidate']) }}
                            <div class="card-header">
                                <div class="row d-flex align-items-center">
                                    <div class="col-6">
                                    ...
                                    <div class="col-6 text-end">
                                        <div class="form-switch custom-switch-v1 d-inline-block">
                                            ...
                                            <small
                                                class="text-end d-flex mt-2">{{ __('Please turn on this Google Map enable button.') }}</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body google_map">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        {{ Form::label('google_map_api', __('Google Map Api Kay'), ['class' => 'col-form-label']) }}
