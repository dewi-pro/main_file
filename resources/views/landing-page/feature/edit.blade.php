{{Form::model(null, array('route' => array('feature.update', $key), 'method' => 'POST','enctype' => "multipart/form-data" , 'data-validate', 'no-validate')) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="form-group">
                {{ Form::label('feature_image', __('Image'), ['class' => 'form-label']) }}
                {{ __('* (svg)') }}
