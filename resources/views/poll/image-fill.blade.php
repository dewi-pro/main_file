                ...
                <div class="card">
                                        ...
                                        <div class="card-footer">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="optional_name"
                                                    value="{{ $option->optional_name }}" id="{{ $option->optional_name }}">
                    ...
                    <div class="card-footer">
                        <div class="text-end">
                            ...
                            <a href="{{ route('poll.image.result', $poll->id) }}" class="btn btn-success"><i class="me-2"
                            ...
                            <a class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="share"
                                ...
                                data-action="{{ route('poll.shares.images', $poll->id) }}"><i class="me-2"
