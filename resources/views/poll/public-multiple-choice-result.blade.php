...
@section('content')
    <div class="row">
        <div class="col-lg-10 col-lg-10 mx-auto mt-5">
            <div class="card p-5">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body ">
                                        <div class="m-auto form-group col-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" value="{{ route('poll.survey', $id) }}"
                                            ...
                                            <div class="mt-3 social-links-share">
                                                <a href="https://api.whatsapp.com/send?text={{ route('poll.survey', $id) }}"
                                                ...
                                                <a href="javascript:void(1);" class="social-links-share-main"
                                                    title="Show QR Code" data-action="{{ route('poll.share.qr', $id) }}"
                                                    id="share-qr">
                                                    <i class="ti ti-qrcode"></i>
                                                </a>
                                                <a href="javascript:void(0)" title="Embed"
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                @if ($poll->allow_comments == 1)
                                    <div class="card">
                                        <div class="card-header">
                                            <h5> <i class="me-2" data-feather="message-circle"></i>{{ __('Comments') }}
                                            </h5>
                                        </div>
                                        {!! Form::open([
                                            'route' => 'comment.store',
