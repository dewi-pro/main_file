                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            @if (isset($array->multiple_answer_options))
                                @foreach ($array->multiple_answer_options as $key => $option)
                                    <div class="col-9">
                    ...
                    <div class="card-footer">
                        <div class="text-end">
                            ...
                            @if ($poll->results_visibility == 'always_public')
                                <a href="{{ route('poll.public.result', $id) }}" class="btn btn-success"><i class="me-2"
                                        data-feather="award"></i>{{ __('Result') }}</a>
                            @elseif($poll->results_visibility == 'public_after_end_date')
                                <a href="{{ route('poll.public.result', $id) }}" class="btn btn-success"><i class="me-2"
                                        data-feather="award"></i>{{ __('Result') }}</a>
                            @elseif($poll->results_visibility == 'public_after_vote')
                                <a href="{{ route('poll.public.result', $id) }}" class="btn btn-success"><i class="me-2"
                                        data-feather="award"></i>{{ __('Result') }}</a>
                            @else
                            @endif
                            <a class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="share"
                                href="javascript:void(0);" id="share-poll" data-action="{{ route('poll.share', $id) }}"><i
