...
@section('content')
    <div class="row">
        {{ Form::model($poll, ['route' => ['meeting.poll.store', $poll->id], 'data-validate', 'method' => 'POST', 'class' => 'form-horizontal']) }}
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            @if (isset($options->meeting_answer_options))
                                @foreach ($options->meeting_answer_options as $key => $option)
                                    <div class="form-group">
                                        <div class="mb-3 input-group vote-metting">
                                            <div class="input-group-text">
                                                <input class="form-check-input" name="meeting_answer_options[]"
                                                    type="checkbox" value="{{ $option->datetime }}"
                    ...
                    <div class="card-footer">
                        <div class="text-end">
                            ...
                            <a href="{{ route('poll.public.result.meeting', $id) }}" class="btn btn-success"><i
