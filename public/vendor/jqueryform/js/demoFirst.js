...
jQuery(function ($) {
    ...
    var templates = {
        ...
        // "profile": function (fieldData) {
        //     console.log(fieldData);
        //     const profileFieldHTML = `
        //     <div class="row" style="margin-bottom: 15px;">
        //     <div class="col-lg-6">
        //         <label style="margin-bottom:5px;">Full Name:</label>
        //         <input type="text" class="form-control" name="first_name_${fieldData.name}" placeholder="Enter First name">
        //     </div>
        //     <div class="col-lg-6">
        //         <label style="margin-bottom:5px;">Last Name:</label>
        //         <input type="text" class="form-control" name="last_name_${fieldData.name}" placeholder="Enter Last name">
        //     </div>
        // </div>
        // <div class="row" style="margin-bottom: 15px;">
        //     <div class="col-lg-12">
        //         <label style="margin-bottom: 5px;">Email:</label>
        //         <input type="email" class="form-control" name="email_${fieldData.name}" placeholder="Enter Email">
        //     </div>
        // </div>
        // <div class="row" style="margin-bottom: 15px;">
        //     <div class="col-lg-5">
        //         <label style="margin-bottom: 5px;">Phone:</label>
        //         <input type="tel" class="form-control" name="phone_${fieldData.name}" placeholder="(000) 000-0000">
        //     </div>
        //     <div class="col-lg-7">
        //         <label style="margin-bottom: 5px;">Gender:</label>
        //         <div class="row">
        //             <div class="col-lg-2 d-flex align-items-center">
        //                 <input type="radio" name="gender_${fieldData.name}" value="male" id="male_${fieldData.name}">
        //                 <label style="margin-left:5px;" for="male_${fieldData.name}">Male</label>
        //             </div>
        //             <div class="col-lg-2 d-flex align-items-center">
        //                 <input type="radio" name="gender_${fieldData.name}" value="female" id="female_${fieldData.name}">
        //                 <label style="margin-left:5px;" for="female_${fieldData.name}">Female</label>
        //             </div>
        //             <div class="col-lg-3 d-flex align-items-center">
        //                 <input type="radio" name="gender_${fieldData.name}" value="other" id="other_${fieldData.name}">
        //                 <label style="margin-left:5px;" for="other_${fieldData.name}">Other</label>
        //             </div>
        //         </div>
        //     </div>
        // </div>`;

        //     // console.log(profileFieldHTML);

        //     // const container = document.getElementById("profileFormContainer");
        //     // console.log(container);

        //     return {
        //         field: profileFieldHTML,
        //     };
