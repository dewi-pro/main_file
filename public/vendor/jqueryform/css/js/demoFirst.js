jQuery(function($) {
  ...
  fbPromise.then(function(fb) {
    ...
    document.getElementById('getJSON').addEventListener('click', function() {
      ...
      tes = formBuilder.actions.getData('json', true);
      ...
      //       }
      //   };
      //   xmlhttp.open("GET", "sweet.php?q=" + tes, true);
      //   xmlhttp.send();
        ...
        xhttp.open("POST", "../Surveyaccess/jsonForm", true);
        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        // xhttp.send("q="+tes+"&lname=Ford");
        xhttp.send("q="+tes+"&ids="+ids);
