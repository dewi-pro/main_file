...
class FormLeaderDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return datatables()
            ->eloquent($query)
            ->addIndexColumn()
            ->addColumn('action', function (FormLeader $leader) {
                return view('form-leader.action', compact('leader'));
            })
            ->editColumn('created_at', function ($request) {
                return UtilityFacades::date_time_format($request->created_at);
            })->editColumn('status', function (FormLeader $leader) {
                $checked = ($leader->status == 1) ? 'checked' : '';
     ...
     *
     * @param \App\Models\FormLeader $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(FormLeader $model): QueryBuilder
    {
    ...
    public function html(): HtmlBuilder
    {
        ...
        $canCreateCategory = \Auth::user()->can('create-form-leader');
    ...
    {
        return 'FormLeader_' . date('YmdHis');
    }
}
