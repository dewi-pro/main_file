...
class NotificationsSettingController extends Controller
{
    ...
    public function changestatus(Request $request, $id)
    {
        if ($request->type == 'email') {
            ...
            return response()->json(['is_success' => true, 'type' => 'email','message' => __('Notification status changed successfully.')]);
        }
        elseif($request->type == 'sms'){
            ...
            return response()->json(['is_success' => true, 'type' => 'sms','message' => __('Notification status changed successfully.')]);
        }
        elseif($request->type == 'notify'){
            ...
            return response()->json(['is_success' => true, 'type' => 'notify','message' => __('Notification status changed successfully.')]);
        }
        else{
