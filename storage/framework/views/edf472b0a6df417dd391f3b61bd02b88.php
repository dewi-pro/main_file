<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('design-form')): ?>
    <a class="btn btn-info btn-sm" href="<?php echo e(route('formTemplate.design', $FormTemplate->id)); ?>" 
...
<?php endif; ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/primelaravel-304/codecanyon-33546000-prime-laravel-form-builder-form-builder-users-role-permissions-settings/main_file/resources/views/form-template/action.blade.php ENDPATH**/ ?>