    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('start_date', $startDate, ['class' => 'form-control ', 'placeholder' => __('Enter start date'), 'id' => 'start_date'])); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('end_date', $endDate, ['class' => 'form-control ', 'placeholder' => __('Enter end date'), 'id' => 'end_date'])); ?>
...
<?php /**PATH /home/dewi/Downloads/primelaravel-304/codecanyon-33546000-prime-laravel-form-builder-form-builder-users-role-permissions-settings/main_file/resources/views/event/create.blade.php ENDPATH**/ ?>