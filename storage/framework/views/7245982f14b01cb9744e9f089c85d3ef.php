<?php $__env->startSection('title', __('Telescope') . (config('app.name') ? ' - ' . config('app.name') : '')); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10"><?php echo e(__('Telescope')); ?></h4>
        </div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><?php echo Html::link(route('home'), __('Dashboard'), ['']); ?></li>
            <li class="breadcrumb-item"><?php echo e(ucfirst(Request::segment(2))); ?></li>
        </ul>
    </div>
    ...
    <div id="telescope" v-cloak>
        ...
        <div class="">
            <div class="d-flex align-items-stretch py-4 header">
                <button class="btn btn-muted ml-auto mr-3 d-flex align-items-center py-2"
                    v-on:click.prevent="toggleRecording" :title="recording ? 'Pause recording' : 'Resume recording'">
                ...
                <div class="col-xl-3 col-12">
                    <div class="card sticky-top">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            <?php echo $__env->make('vendor.telescope.telescope-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                </div>
