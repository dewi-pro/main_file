                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        <div class="banner-image">
                            <img src="<?php echo e(Storage::url(Utility::getsettings('apps_image'))); ?>" alt="home-banner-image"
                                            ...
                                            <div class="author-img">
                                                <?php if(Auth::check()): ?>
                                                    <img src="<?php echo e(Storage::exists(Auth::user()->avatar) ? Storage::url(Auth::user()->avatar) : Auth::user()->avatar_image); ?>"
                                                        alt="client-image">
                                                <?php else: ?>
                                                    <img src="<?php echo e(Storage::url('avatar/avatar.png')); ?>"
                                                        alt="client-image">
                                                <?php endif; ?>
                                            </div>
                                            <?php if(\Auth::user()): ?>
...
<?php /**PATH /home/dewi/Downloads/primelaravel-304/codecanyon-33546000-prime-laravel-form-builder-form-builder-users-role-permissions-settings/main_file/resources/views/welcome.blade.php ENDPATH**/ ?>