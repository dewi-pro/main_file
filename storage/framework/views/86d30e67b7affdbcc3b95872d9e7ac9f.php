<?php $__env->startSection('title', __('Edit Document')); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10"><?php echo e(__('Edit Document')); ?></h4>
        </div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><?php echo Html::link(route('home'), __('Dashboard'), []); ?></li>
            <li class="breadcrumb-item"><a href="<?php echo e(route('document.index')); ?>"><?php echo e(__('Documents')); ?></a></li>
            <li class="breadcrumb-item active"><?php echo e(__('Edit Document')); ?></li>
        </ul>
    </div>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="m-auto col-lg-8 card-main">
            ...
            <div class="card">
                <div class="card-header">
                    <h5><?php echo e(__('Edit Document')); ?></h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <?php echo Form::text('title', $document->title, [
                                    'class' => 'form-control',
                                    ' required',
                            ...
                            <div class="form-group">
                                <?php if($document->logo): ?>
                                    <div class="text-center">
                                        <img src="<?php echo e(Storage::url($document->logo)); ?>"
                                            class="text-center img img-responsive justify-content-center document-img" />
                                    </div>
                                <?php endif; ?>
                                <?php echo e(Form::label('document_logo', __('Select Logo'), ['class' => 'form-label'])); ?> <br>
                            ...
                            <div class="form-group">
                                <label for="select-themes" class="form-label"><?php echo e(__('Select Themes')); ?></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-check form-switch">
                                        <input class="form-check-input float-end" id="change_log_status"
                                            ...
                                            <?php echo e($document->change_log_status == 'on' ? 'checked' : ''); ?> type="checkbox">
                                        <span class="custom-switch-indicator"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group changeLog <?php echo e($document->change_log_status == 'off' ? 'd-none' : ''); ?> ">
                                <div class="repeater2">
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            <?php if($document->change_log_json): ?>
                var Json = JSON.parse(<?php echo json_encode($document->change_log_json); ?>);
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dewi/Downloads/primelaravel-304/codecanyon-33546000-prime-laravel-form-builder-form-builder-users-role-permissions-settings/main_file/resources/views/document/edit.blade.php ENDPATH**/ ?>