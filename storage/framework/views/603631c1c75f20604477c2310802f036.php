...
<div class="modal-body">
    ...
    <div class="form-group">
        <?php echo e(Form::label('color', __('Select Color'), ['class' => 'form-label'])); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/primelaravel-304/codecanyon-33546000-prime-laravel-form-builder-form-builder-users-role-permissions-settings/main_file/resources/views/form-status/create.blade.php ENDPATH**/ ?>